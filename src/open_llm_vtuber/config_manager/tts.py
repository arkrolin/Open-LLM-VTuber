...
class IndexTTSConfig(I18nMixin):
    ...
    vec1: float = Field(0, alias="vec1")
    vec2: float = Field(0, alias="vec2")
    vec3: float = Field(0, alias="vec3")
    vec4: float = Field(0, alias="vec4")
    vec5: float = Field(0, alias="vec5")
    vec6: float = Field(0, alias="vec6")
    vec7: float = Field(0, alias="vec7")
    vec8: float = Field(0, alias="vec8")
